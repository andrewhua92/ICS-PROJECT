...
public class Player {
	...
	// Constructor
	public Player(Stats stats, Type type, String gender, String name, boolean sufficientSleep, Course[] schedule,
			int month) {
		this.stats = stats;
		this.type = type;
		this.gender = gender;
	...
	public void spendTime() {
		...
		System.out.printf("You are given 6 hours of sleep, plus %f hours left over.", timeLeft);
		sleep(timeLeft);
	}
